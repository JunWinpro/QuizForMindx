...
const GoogleCallback  = lazy(() => import("./pages/GoogleCallback")); // MỚI: Google OAuth callback
      ...
      <AuthProvider>
        ...
        <Suspense fallback={<PageLoader />}>
          <Routes>
            ...
            <Route path="/auth/callback" element={<GoogleCallback />} /> {/* MỚI: Google OAuth callback route */}
